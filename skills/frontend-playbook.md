...
└─ No protocols                 └─ Uniswap, Aeve, etc. available
...
- RPC config has `rpcOverrides` and `pollingInterval: 3000`

### Step 2: Choose Domain
Ask: *"What subdomain do you want? e.g. `myapp.yourname.eth` -> `myapp.yourname.eth.link`"*

### Step 3: Generate OG Image + Fix Metadata
- Create 1200x630 PNG (`public/thumbnail.png`) — NOT the stock SE2 thumbnail
